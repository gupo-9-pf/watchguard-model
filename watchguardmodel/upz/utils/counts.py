...
def get_counts(df: pd.DataFrame, severity_data: pd.DataFrame) -> dict:
    query_data = {
        'morning_bike_m': query(df, 'mañana', 'hurto de bicicletas', ['masculino', '-']),
        'morning_bike_f': query(df, 'mañana', 'hurto de bicicletas', ['femenino', '-']),
        'aftern_bike_m': query(df, 'tarde', 'hurto de bicicletas', ['masculino', '-']),
        'aftern_bike_f': query(df, 'tarde', 'hurto de bicicletas', ['femenino', '-']),
        'night_bike_m': query(df, 'noche', 'hurto de bicicletas', ['masculino', '-']),
        'night_bike_f': query(df, 'noche', 'hurto de bicicletas', ['femenino', '-']),
        'morning_foot_m': query(df, 'mañana', ['hurto a personas', 'hurto de celulares'], ['masculino', '-']),
        'morning_foot_f': query(df, 'mañana', ['hurto a personas', 'hurto de celulares'], ['femenino', '-']),
        'aftern_foot_m': query(df, 'tarde', ['hurto a personas', 'hurto de celulares'], ['masculino', '-']),
        'aftern_foot_f': query(df, 'tarde', ['hurto a personas', 'hurto de celulares'], ['femenino', '-']),
        'night_foot_m': query(df, 'noche', ['hurto a personas', 'hurto de celulares'], ['femenino', '-']),
        'night_foot_f': query(df, 'noche', ['hurto a personas', 'hurto de celulares'], ['femenino', '-']),
